...
public class CircularProgressView extends View{
    ...
    private int[] mColors;   //多种颜色的颜色组
    private int color_single;     //单种颜色
    ...
    public CircularProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        color_single = a.getInt(R.styleable.CircularProgressView_progressColor,R.array.circular_default_color_my);      //单种颜色的
        a.recycle();
...
//        mPaint.setColor(mColors[mCurrentColorIndex]);   //设置多种颜色切换
        mPaint.setColor(color_single);        //设置单种颜色
        setupAnimations();
    }
...
//                    mCurrentSweepAngle / (360 - minSweepAngle * 2)));
            mPaint.setColor(color_single);  //设置单种颜色loading
